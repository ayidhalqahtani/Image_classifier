...
valiadtion_data= datasets.ImageFolder(valid_dir,transform=validation_transforms)
...
validation_loader =torch.utils.data.DataLoader(valiadtion_data, batch_size =50,shuffle = True)
...
#based on the above suggestion we will use VGG network
...
model
# we defined the the optimizer and loss for our classifier.
...
# we downloaded our pretrained vgg19 model
    model = models.vgg19(pretrained=True);
...
## To test the process image function that it has processed the images
